...
Pod::Spec.new do |s|
  s.name             = 'YGElfControl'
  s.version          = '0.1.0'
  s.summary          = 'A short description of YGElfControl.'
...
一些常用的UI控件.
  ...
  s.homepage         = 'https://github.com/rays/YGElfControl'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'rays' => '376906177@qq.com' }
  s.source           = { :git => 'https://github.com/rays/YGElfControl.git', :tag => s.version.to_s }
